export const projects = [
    {
        ...
        description: 'Twitter clone based on a .Net Core web api. The front-end is built with a react spa developed with typescript and MobX as a state management library. Registration and authentication are managed through .Net Core Identity. This application is designed for desktop experience only.',
    ...
    },
    {
        ...
        description: 'Trello inspired kanban board, realised with react-beatiful-dnd. Lists and cards are draggable and droppable. The board state is managed through Redux and the changes are saved in local storage.',
